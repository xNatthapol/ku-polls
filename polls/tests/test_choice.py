...
class ChoiceTest(TestCase):
    def test_add_choice(self):
        ...
        # Create a question
        question = Question.objects.create(question_text="Question test 001", pub_date=time)
        # Create a choice
        choice = Choice.objects.create(question=question, choice_text="choice test 001")
